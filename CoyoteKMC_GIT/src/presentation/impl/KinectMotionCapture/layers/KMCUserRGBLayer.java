 ...
 * @author almerindo
 */
public class KMCUserRGBLayer extends ALayerShape {

    Dimension pSize = null;
    Image img = null;
    ImageObserver imgObs = null;

    public KMCUserRGBLayer(Image img, ImageObserver imgObs, Dimension pSize) throws Exception {
        super();
        this.setImage(img);
    ...
    public void draw(Graphics g) {
        //    this.setImage(KinectAccess.getScreenUsers());
